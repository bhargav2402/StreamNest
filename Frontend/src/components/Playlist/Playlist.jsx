...
export default function Playlist() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://stream-nest.vercel.app/api/playlist/${id}`)
            .then(res => {
    ...
    const removeVideo = (vidId) => {
        axios.delete(`https://stream-nest.vercel.app/api/playlist/video/${vidId}/${id}`)
            .then(res => {
    ...
    const deletePlaylist = () => {
        axios.delete(`https://stream-nest.vercel.app/api/playlist/${playlist._id}`)
        navigate(-1)
        setTimeout(() => {
    ...
    const saveChanges = () => {
        axios.post(`https://stream-nest.vercel.app/api/playlist/${playlist._id}`, { name: newTitle, description: newDescription })
            .then(res => {
