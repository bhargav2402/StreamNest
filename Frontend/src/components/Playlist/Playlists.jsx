...
export default function Playlists({ channelId = "" }) {
    ...
    useEffect(() => {
        axios.get(`https://streamnest-3hxb.onrender.com/playlist/user/${userId}`)
            .then((res) => {
    ...
    const deletePlaylist = (e, id) => {
        e.stopPropagation()
        axios.delete(`https://streamnest-3hxb.onrender.com/playlist/${id}`)
    ...
    const newPlaylist = (e) => {
        ...
        axios.post(`https://streamnest-3hxb.onrender.com/playlist`, { name, description: desc })
            .then(res => {
