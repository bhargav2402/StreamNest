...
function VideoPage() {
    ...
    useEffect(() => {
        axios.get(`https://stream-nest.vercel.app/api/video/v/${videoId}`)
            .then((res) => {
        ...
        axios.get(`https://stream-nest.vercel.app/api/comment/video/${videoId}`)
            .then((res) => setComments(res.data.data.docs))
            .catch(error => console.log(error.response.data));

        axios.post(`https://stream-nest.vercel.app/api/watchHistory/track/${videoId}`)
            .catch(error => console.log(error.response.data));
    ...
    const toggleSub = () => {
        axios.post(`https://stream-nest.vercel.app/api/subscription/channel/${video.owner._id}`)
            .then(res => {
                setVideo({
                    ...video,
    ...
    const toggleVideoLike = () => {
        axios.post(`https://stream-nest.vercel.app/api/like/v/${videoId}`)
            .then((res) => setVideo(
                video => ({
                    ...video,
    ...
    const addComment = () => {
        if (content && content.trim()) {
            ...
            axios.post(`https://stream-nest.vercel.app/api/comment/video/${videoId}`, { content })
                .then((res) => {
    ...
    const deleteComment = (id) => {
        axios.delete(`https://stream-nest.vercel.app/api/comment/c/${id}`)
    ...
    const toggleCommentLike = (commentId) => {
        axios.post(`https://stream-nest.vercel.app/api/like/c/${commentId}`)
    ...
    const toggleModal = () => {
        ...
        if (!isModalOpen) {
            ...
            axios.get(`https://stream-nest.vercel.app/api/playlist/user/${currentUser._id}`)
    ...
    const addToPlaylist = (playlistId) => {
        axios.post(`https://stream-nest.vercel.app/api/playlist/video/${videoId}/${playlistId}`,)
            .then(res => {
