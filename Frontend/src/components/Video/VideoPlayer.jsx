...
function VideoPage() {
    ...
    useEffect(() => {
        axios.get(`https://streamnest-3hxb.onrender.com/video/v/${videoId}`)
            .then((res) => {
        ...
        axios.get(`https://streamnest-3hxb.onrender.com/comment/video/${videoId}`)
            .then((res) => setComments(res.data.data.docs))
            .catch(error => console.log(error.response.data));

        axios.post(`https://streamnest-3hxb.onrender.com/watchHistory/track/${videoId}`)
            .catch(error => console.log(error.response.data));
    ...
    const toggleSub = () => {
        axios.post(`https://streamnest-3hxb.onrender.com/subscription/channel/${video.owner._id}`)
            .then(res => {
                setVideo({
                    ...video,
    ...
    const toggleVideoLike = () => {
        axios.post(`https://streamnest-3hxb.onrender.com/like/v/${videoId}`)
            .then((res) => setVideo(
                video => ({
                    ...video,
    ...
    const addComment = () => {
        if (content && content.trim()) {
            ...
            axios.post(`https://streamnest-3hxb.onrender.com/comment/video/${videoId}`, { content })
                .then((res) => {
    ...
    const toggleModal = () => {
        ...
        if (!isModalOpen) {
            ...
            axios.get(`https://streamnest-3hxb.onrender.com/playlist/user/${currentUser._id}`)
    ...
    const addToPlaylist = (playlistId) => {
        axios.post(`https://streamnest-3hxb.onrender.com/playlist/video/${videoId}/${playlistId}`,)
            .then(res => {
