...
export default function PostItem() {
    ...
    useEffect(() => {
        axios.get(`https://stream-nest.vercel.app/api/post/${postId}`)
            .then((res) => {
        ...
        axios.get(`https://stream-nest.vercel.app/api/comment/post/${postId}`)
    ...
    const togglePostLike = (e) => {
        ...
        axios.post(`https://stream-nest.vercel.app/api/like/p/${postId}`)
            .then((res) => setPost(
                post => ({
                    ...post,
    ...
    const deletePost = () => {
        ...
        axios.delete(`https://stream-nest.vercel.app/api/post/${postId}`)
            .then((res) => {
                navigate(-1)
                setTimeout(() => {
    ...
    const addComment = () => {
        if (content && content.trim()) {
            ...
            axios.post(`https://stream-nest.vercel.app/api/comment/post/${postId}`, { content })
                .then((res) => {
