...
export default function PostItem() {
    ...
    useEffect(() => {
        axios.get(`https://streamnest.onrender.com/api/post/${postId}`)
            .then((res) => {
        ...
        axios.get(`https://streamnest.onrender.com/api/comment/post/${postId}`)
    ...
    const togglePostLike = (e) => {
        ...
        axios.post(`https://streamnest.onrender.com/api/like/p/${postId}`)
            .then((res) => setPost(
                post => ({
                    ...post,
    ...
    const deletePost = () => {
        ...
        axios.delete(`https://streamnest.onrender.com/api/post/${postId}`)
            .then((res) => {
                navigate(-1)
                setTimeout(() => {
    ...
    const addComment = () => {
        if (content && content.trim()) {
            ...
            axios.post(`https://streamnest.onrender.com/api/comment/post/${postId}`, { content })
                .then((res) => {
