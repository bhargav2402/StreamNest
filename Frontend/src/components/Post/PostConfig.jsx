...
export default function PostConfig() {
    ...
    useEffect(() => {
        if (editMode) {
            axios.get(`https://streamnest-3hxb.onrender.com/post/${postId}`)  // To edit post
                .then((res) => {
    ...
    const config = () => {
        if (editMode) {
            if (content !== currContent) {
                axios.post(`https://streamnest-3hxb.onrender.com/post/${postId}`, { content })
                    .then(res => {
                        setTimeout(() => {
            ...
            if (!content || content.trim()) {
                axios.post(`https://streamnest-3hxb.onrender.com/post/new`, { content })
                    .then(res => {
                        setTimeout(() => {
