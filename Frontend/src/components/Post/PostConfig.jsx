...
export default function PostConfig() {
    ...
    useEffect(() => {
        if (editMode) {
            axios.get(`https://stream-nest.vercel.app/api/post/${postId}`)  // To edit post
                .then((res) => {
    ...
    const config = () => {
        if (editMode) {
            if (content !== currContent) {
                axios.post(`https://stream-nest.vercel.app/api/post/${postId}`, { content })
                    .then(res => {
                        setTimeout(() => {
            ...
            if (!content || content.trim()) {
                axios.post(`https://stream-nest.vercel.app/api/post/new`, { content })
                    .then(res => {
                        setTimeout(() => {
