...
export default function PostConfig() {
    ...
    useEffect(() => {
        if (editMode) {
            axios.get(`https://streamnest.onrender.com/api/post/${postId}`)  // To edit post
                .then((res) => {
    ...
    const config = () => {
        if (editMode) {
            if (content !== currContent) {
                axios.post(`https://streamnest.onrender.com/api/post/${postId}`, { content })
                    .then(res => {
                        setTimeout(() => {
            ...
            if (!content || content.trim()) {
                axios.post(`https://streamnest.onrender.com/api/post/new`, { content })
                    .then(res => {
                        setTimeout(() => {
