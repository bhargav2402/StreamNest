...
export default function Profile() {
    ...
    useEffect(() => {
        axios.get("https://streamnest.onrender.com/api/users/current_user")
            .then(res => {
    ...
    const handleSubmit = (e) => {
        ...
        if (formData.fullname !== user.fullname || formData.email !== user.email) {
            ...
            axios.patch("https://streamnest.onrender.com/api/users/update_details", {
        ...
        if (formData.oldPassword && formData.newPassword) {
            axios.patch("https://streamnest.onrender.com/api/users/change_password", {
        ...
        if (avatarFile) {
            ...
            axios.patchForm("https://streamnest.onrender.com/api/users/update_avatar", {
                "avatar": avatarFile
            })
        ...
        if (covImgFile) {
            ...
            axios.patchForm("https://streamnest.onrender.com/api/users/update_cover_image", {
